    ...
    return (
        <div className="green darken-2">
            <div className="plantIcon__div large">
                <div><i className="material-icons yellow-text text-darken-2">local_florist</i></div>
                <div><i className="material-icons yellow-text text-darken-2">local_florist</i></div>
            </div>
            ...
            <div className="favorite__div"><i className="material-icons red-text text-darken-3">favorite</i></div>
        </div>
    )
}
